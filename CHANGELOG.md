...
## [1.0.0](https://github.com/Sokori-Inc/plunk/compare/v0.15.0...v1.0.0) (2026-09-23)
...
* Ability to change subscription status in workflows ([fadc19d](https://github.com/Sokori-Inc/plunk/commit/fadc19d139084550eb442a8b8368edcd6075cad0))
* Ability to change workflow trigger ([eec37ec](https://github.com/Sokori-Inc/plunk/commit/eec37ecb31c63888879a1933dba4fd0c6243018b))
* add 'notTriggeredWithin' operator to segment filters for enhanced event tracking ([0f00ca1](https://github.com/Sokori-Inc/plunk/commit/0f00ca1b8c9bd95f2158af845218ef432ab0d498))
* Add ability to snooze contacts instead of unsubscribing ([787d200](https://github.com/Sokori-Inc/plunk/commit/787d200acd47d4be6b447a6649fc602f59d49e5a))
* Add ability to snooze contacts instead of unsubscribing ([04dab0c](https://github.com/Sokori-Inc/plunk/commit/04dab0cd814168b64dca8020b156703e0d93172c))
* Add accept/markdown to apps/landing ([df76be1](https://github.com/Sokori-Inc/plunk/commit/df76be1b87de14769a219ae0e6c99711edf993a1))
* Add additional card verification in worker ([33cc815](https://github.com/Sokori-Inc/plunk/commit/33cc81547c2d2d936f2977680239429ef025c6eb))
* Add additional tools to MCP for contacts and campaigns ([24b48cb](https://github.com/Sokori-Inc/plunk/commit/24b48cbfbde3cc15b784a3aca1701194305dd9f0))
* Add advanced DNS configuration ([7964563](https://github.com/Sokori-Inc/plunk/commit/7964563b620868279f5fb6baab0d7499c41f51ed))
* Add automatic conversion to text/plain ([17e840b](https://github.com/Sokori-Inc/plunk/commit/17e840b6d039af8b85217ed8c1de3267b75fd615))
* Add billing for inbound ([3330d83](https://github.com/Sokori-Inc/plunk/commit/3330d83d08904bc547740bfc9fdcbc5ff214d977))
* Add billing for inbound ([de7ed84](https://github.com/Sokori-Inc/plunk/commit/de7ed84fcfddde16a9297c947048e9876712f6fa))
* Add bounce and complaint filter to activity feed ([c85df75](https://github.com/Sokori-Inc/plunk/commit/c85df75d539f7e5500a9a109966b0e6d654d4022))
* add className prop to EmptyState component for custom styling ([c278a0f](https://github.com/Sokori-Inc/plunk/commit/c278a0fd944977d4ea3a0c5a4a43ff4cc0a13aa3))
* add composite index on campaignId and status for efficient campaign completion checks ([4b752a5](https://github.com/Sokori-Inc/plunk/commit/4b752a527b1c4da1cd211869ac33ba124bf8aa66)), closes [#400](https://github.com/Sokori-Inc/plunk/issues/400)
* add configurable attachment limits for email service ([2eb4079](https://github.com/Sokori-Inc/plunk/commit/2eb407993bd5fed3e74be73445185e517c18b994)), closes [#358](https://github.com/Sokori-Inc/plunk/issues/358)
* Add dedicated events for contact.subscribe and contact.unsubscribe ([ab4a48b](https://github.com/Sokori-Inc/plunk/commit/ab4a48b347ab196d5af4655e3aa7d75e1a06e580))
* Add dedicated received type ([f947ee6](https://github.com/Sokori-Inc/plunk/commit/f947ee6f22371055801fa9cfc62e15df7851986c))
* add disabledReason field to projects for better tracking of disable reasons ([94ceadb](https://github.com/Sokori-Inc/plunk/commit/94ceadbbe417f0cb3ab72c66bfad9428bdce2d11))
* add documentation link and redirect to WIKI_URI ([4c81d9e](https://github.com/Sokori-Inc/plunk/commit/4c81d9ec04003550b140d884f37ebbf13137166d))
* add email body cleanup job to remove old email content after 90 days ([cef8ce0](https://github.com/Sokori-Inc/plunk/commit/cef8ce0b419ae29d3527c8038318bf4be9f62f5d))
* Add emailId field to webhook events for better correlation with send requests ([ae64c2d](https://github.com/Sokori-Inc/plunk/commit/ae64c2dbb5b76f16b562641953f262d76ea0d8e8)), closes [#344](https://github.com/Sokori-Inc/plunk/issues/344)
* Add event context to send email step ([4fa6379](https://github.com/Sokori-Inc/plunk/commit/4fa63795a07afea5740bccf7d55c2976d4e0e1b8))
* add external link to edit email templates in SendEmailStepDialog and WorkflowBuilder ([4ba43dd](https://github.com/Sokori-Inc/plunk/commit/4ba43dd3b64776413f813e091f527aa3e56bfc84))
* Add foundations for Plunk MCP Server ([5828309](https://github.com/Sokori-Inc/plunk/commit/5828309ce41794bf39d35df49639c5cfe8e3b7fc))
* Add foundations for Plunk MCP Server ([00b0a92](https://github.com/Sokori-Inc/plunk/commit/00b0a92bf9dd883f05bd5d44e5fde026e1a35ca2))
* Add foundations for Plunk MCP Server ([7167a0a](https://github.com/Sokori-Inc/plunk/commit/7167a0a2bba5992f230292240ef9d582511ec775))
* Add headless template type ([fb5aa87](https://github.com/Sokori-Inc/plunk/commit/fb5aa8796a8550be7a70fdd91616c9a41ed3047d))
* Add improved tracking for unsubscribes and complaints ([37626cb](https://github.com/Sokori-Inc/plunk/commit/37626cb5d5a0a208ed0bc6a2ab1bd4d3be2731ef))
* Add inbound handling ([d050b55](https://github.com/Sokori-Inc/plunk/commit/d050b55baaf46306be3fb6e5ad683205e158bd65))
* Add initial handling in webhook for inbound ([e01dc40](https://github.com/Sokori-Inc/plunk/commit/e01dc4066c5e5eb5e0e69ef92f8a5bb7786e5a91))
* Add initial handling in webhook for inbound ([c286f49](https://github.com/Sokori-Inc/plunk/commit/c286f490974d8dfe9c94695c63e6b48216b8052d))
* add Markdown cut link to footer and page for improved accessibility ([ccd516e](https://github.com/Sokori-Inc/plunk/commit/ccd516e4e882921fb1a8a3e87c47710e51e35311))
* add middleware support for .md file rewrites ([0b3aa28](https://github.com/Sokori-Inc/plunk/commit/0b3aa28101d50a734945ce19b924f9aa30631c64))
* add minimum thresholds for bounce and complaint rates ([d55dda3](https://github.com/Sokori-Inc/plunk/commit/d55dda312718890231d1a428448e607792799c84))
* Add multi-branch workflow conditions (switch/case) ([92949b7](https://github.com/Sokori-Inc/plunk/commit/92949b7596740b73d04c30e0e2bcc6305bbdf4a7))
* Add onboarding flow ([bd5a085](https://github.com/Sokori-Inc/plunk/commit/bd5a0858021b9d74fae07cca5d2a0b8c10deabd7))
* Add optional rate limiting for track, send and contact endpoints ([05080e7](https://github.com/Sokori-Inc/plunk/commit/05080e71714edaa5d13875e313504c748315d39f))
* add project switching functionality to command palette ([5724ab9](https://github.com/Sokori-Inc/plunk/commit/5724ab9536ea4e3bb4e916e963b1f39ba51bb7f3))
* add sanitize-html for improved email content sanitization ([735acff](https://github.com/Sokori-Inc/plunk/commit/735acff45423cb537f7aa636b9a9d31830775f93))
* add search functionality to campaigns list with debounce effect ([d114950](https://github.com/Sokori-Inc/plunk/commit/d11495061d907bcee699d56987784fa7ebe31bf6))
* add segment membership operators and enhance segment filter functionality ([a3cc622](https://github.com/Sokori-Inc/plunk/commit/a3cc62213f40f6a9341113b73b52852292fb9a10))
* Add sponsor link in navbar ([32142c3](https://github.com/Sokori-Inc/plunk/commit/32142c3d4d76e504ef52dca14e84557cfd8d7175))
* Add support for custom email recipients in workflow steps ([78d3d22](https://github.com/Sokori-Inc/plunk/commit/78d3d224af60cf5b58c6b18fdd0921320912fb09))
* add SwitchOffer component to promote switching from competitors for enhanced user engagement ([6195b39](https://github.com/Sokori-Inc/plunk/commit/6195b39f3dbdd9fe783b79f9ae7f7942509a49a0))
* Add type to campaign ([d24259e](https://github.com/Sokori-Inc/plunk/commit/d24259e8d202edd1b8c7771a63cc212c982b52e1))
* add updateActiveProject function for in-place project updates ([6f31fa2](https://github.com/Sokori-Inc/plunk/commit/6f31fa2503b11e3a9a37d753086bbb74b42f7bc4))
* add Welsh translations ([9457556](https://github.com/Sokori-Inc/plunk/commit/94575561b88180a8500912cc5a1471b411da6fa3))
* add Welsh translations ([53a655c](https://github.com/Sokori-Inc/plunk/commit/53a655c4640f1c6298d6fd02b1e5eaf5b9158df6))
* add workflow duplication functionality with API endpoint and UI button ([c6340a1](https://github.com/Sokori-Inc/plunk/commit/c6340a1dc7385723d4ec30779340218935d814e6))
* **api:** allow API key authentication for domain endpoints ([d2496bc](https://github.com/Sokori-Inc/plunk/commit/d2496bc51d17657380160dbfc20e099d3f4eadba))
* **api:** allow API key authentication for domain endpoints ([3f30a48](https://github.com/Sokori-Inc/plunk/commit/3f30a48c406bab3f145bc5e174525e985616eb50))
* **api:** insert steps mid-transition and validate connections ([6343ef5](https://github.com/Sokori-Inc/plunk/commit/6343ef50a9abbeb2e350b611b9c746ba4d5e5c65))
* **api:** support inline images in emails using Content-ID ([9b15b93](https://github.com/Sokori-Inc/plunk/commit/9b15b93b96344f811d869d103b3b6d344b531811))
* **api:** support inline images in emails using Content-ID ([c40394f](https://github.com/Sokori-Inc/plunk/commit/c40394ffd6ef3dc844b9e475e20324cb4c5f0055))
* Archive campaigns ([ea1fb5a](https://github.com/Sokori-Inc/plunk/commit/ea1fb5a5b3d7b913b89196c8c3a47385b24932c5))
* Block domain changes for disabled projects with appropriate error handling ([44c8657](https://github.com/Sokori-Inc/plunk/commit/44c86572c275221b5068605c64958f43a1f96ff4))
* bulk delete for workflows and campaigns ([a05034e](https://github.com/Sokori-Inc/plunk/commit/a05034e517d8811aa941bc6be111fa94491e881a))
* classify emails and build headers based on email type ([8f23d8a](https://github.com/Sokori-Inc/plunk/commit/8f23d8aac479ae4e7d9926965f090c75afd3f6d5)), closes [#411](https://github.com/Sokori-Inc/plunk/issues/411)
* **Contacts:** add subscription status filter and enhance query capabilities ([8564016](https://github.com/Sokori-Inc/plunk/commit/85640162ce8461f76df9f125db6119f5eed26e87))
* **contacts:** make email cell a link to the contact detail page ([6759bff](https://github.com/Sokori-Inc/plunk/commit/6759bffd2a1f0bfb09b754bb0efdfe5c347ea2b3))
* **contacts:** make email cell a link to the contact detail page ([6d98d51](https://github.com/Sokori-Inc/plunk/commit/6d98d512222ffb422bc2a4bef4284a644558b39d))
* Delete account ([93fa1bf](https://github.com/Sokori-Inc/plunk/commit/93fa1bf751d9da59b2d90b4a64bcdcd659825764))
* Disable projects on failed payment ([3343e89](https://github.com/Sokori-Inc/plunk/commit/3343e891bdbcfee7d17d73a0d7fb181652e7c262))
* **EmailService:** add worker concurrency settings and improve email queue prioritization ([80beb2b](https://github.com/Sokori-Inc/plunk/commit/80beb2bb9937101d1723f2d54648060fdcbe6cef))
* enhance campaign scheduling and audience settings UI for better clarity and usability ([7658a59](https://github.com/Sokori-Inc/plunk/commit/7658a59b5df4e325ad9eca37356cad3cbb70e942))
* enhance contact addition with bulk email lookup and subscription options ([bb72911](https://github.com/Sokori-Inc/plunk/commit/bb72911fa25e3a204095e74c07efbc261154ac30))
* enhance contact data handling by filtering empty strings and allowing null to delete fields ([1094651](https://github.com/Sokori-Inc/plunk/commit/10946511b019ff76ce5f785a39cc0db4ea9ce820))
* Enhance ease of use of workflow editor ([c910d20](https://github.com/Sokori-Inc/plunk/commit/c910d20bb71ff5de4abf95f3f96be9c435342cb4))
* Enhance email processing to include parsed HTML body content in inbound email records ([e339508](https://github.com/Sokori-Inc/plunk/commit/e3395083db11fdb4b6cfdbace46518792ec132a3)), closes [#342](https://github.com/Sokori-Inc/plunk/issues/342)
* Enhance login forms with last used authentication method ([f2ebce0](https://github.com/Sokori-Inc/plunk/commit/f2ebce0ef2ac9c9c4e994cb754f67f6fa8a3f465))
* Enhance security metrics handling with new thresholds and improved messaging ([c0b2aba](https://github.com/Sokori-Inc/plunk/commit/c0b2abaeca5656743e189f975ab82ff9b25b577b))
* extend table view to workflows and campaigns list pages ([e932b2d](https://github.com/Sokori-Inc/plunk/commit/e932b2dccb685e46d9a6ff82babd488a5e068e53))
* Handle simulated AWS addresses. ([0d502da](https://github.com/Sokori-Inc/plunk/commit/0d502da15c33c29ed18cfccff64be30b8bff3298)), closes [#491](https://github.com/Sokori-Inc/plunk/issues/491)
* hide signup link from login when DISABLE_SIGNUPS is set ([21ea0b8](https://github.com/Sokori-Inc/plunk/commit/21ea0b80d63b8897bb74323820e6dacae5ab1feb))
* hide signup link from login when DISABLE_SIGNUPS is set ([1a68b68](https://github.com/Sokori-Inc/plunk/commit/1a68b688e4ce1120e550a809ad7cac0832d1237a))
* **i18n:** add Chinese translations (zh-TW, zh-HK, zh-CN) ([33df563](https://github.com/Sokori-Inc/plunk/commit/33df5632a3d4068e641687c8d404a6eef4aa4d0e))
* **i18n:** add Czech locale translations ([14c471e](https://github.com/Sokori-Inc/plunk/commit/14c471e4cadbe1bbf90e53522134fad3d81ff107))
* **i18n:** add Italian translation ([7b6872c](https://github.com/Sokori-Inc/plunk/commit/7b6872c4b79b0fde4491f02851a2049c846c83d6))
* **i18n:** add Japanese (ja) translations ([e399d0c](https://github.com/Sokori-Inc/plunk/commit/e399d0c0bc24e08991c9839a0604cdff4985a995))
* **i18n:** add Japanese (ja) translations ([f34c0e1](https://github.com/Sokori-Inc/plunk/commit/f34c0e13dd1146c3310f74c49090f9db1a9ee8ec))
* **i18n:** add Polish locale translations ([7a6df77](https://github.com/Sokori-Inc/plunk/commit/7a6df7760bc73dfe80dcf2d37612e320f6de1d30))
* **i18n:** add Polish locale translations ([d2d779c](https://github.com/Sokori-Inc/plunk/commit/d2d779c68f958a6ac0e77b7588e92a5c705a8fd4)), closes [#246](https://github.com/Sokori-Inc/plunk/issues/246)
* **i18n:** Add Spanish language ([9c69c7a](https://github.com/Sokori-Inc/plunk/commit/9c69c7a36edd86fdc02b8d0d3e3f8d64ed8ecfa6))
* **i18n:** add Swedish (sv) translations ([1fbaccc](https://github.com/Sokori-Inc/plunk/commit/1fbaccccb06f5d94e4e6a65b84f4c03178d10356))
* **i18n:** add Swedish (sv) translations ([bdd5ab7](https://github.com/Sokori-Inc/plunk/commit/bdd5ab777befececce5350dfb3755046296beb11))
* implement AWS SNS signature verification in SecurityService ([b79d416](https://github.com/Sokori-Inc/plunk/commit/b79d4166671cc04cc1458d2c24af262af0e16c9e))
* implement bulk contact action selector for improved flexibility in bulk operations ([de6335e](https://github.com/Sokori-Inc/plunk/commit/de6335e99999242f81e9eda9a20aeccab80a2de4))
* implement caching for recent activity count to optimize performance and reduce database load ([f22da4a](https://github.com/Sokori-Inc/plunk/commit/f22da4add1e455678f380aba8c2fd02012ef6457))
* implement CommandPalette for enhanced navigation and recent pages tracking ([1c89ed0](https://github.com/Sokori-Inc/plunk/commit/1c89ed083e49148967713e9a9c2f7f8833db07c4))
* implement deterministic avatar gradient generation for user accounts ([e0e79cc](https://github.com/Sokori-Inc/plunk/commit/e0e79cc8e7bce6f63e871e4630bcf6ed36a36ca0))
* implement early fraud warning handling in webhooks ([48425d1](https://github.com/Sokori-Inc/plunk/commit/48425d1df160a3fd5edb4cbdcc9e6725628db319))
* implement idempotency for POST /v1/track and POST /v1/send with cleanup job ([94c85ac](https://github.com/Sokori-Inc/plunk/commit/94c85acf2441049b866a520d7e083e1b65aa4944))
* implement liquidjs templating system ([39249d3](https://github.com/Sokori-Inc/plunk/commit/39249d31f9673c212a035a377eefa62368afac43))
* implement meter event processing with queue for Stripe billing ([e048fc1](https://github.com/Sokori-Inc/plunk/commit/e048fc157080b36f40fbfc4440db51367a2d374b))
* implement phishing detection using OpenRouter API with configurable sampling rate ([2da8b06](https://github.com/Sokori-Inc/plunk/commit/2da8b065d08438aa2adea397d8ab2a560e996af6))
* Improved bounce and complaint stats for campaigns ([9b11de5](https://github.com/Sokori-Inc/plunk/commit/9b11de581f1bc4bebce134cc0ed9d66589e09733))
* insert, disconnect and reconnect steps in the workflow editor ([aa4b011](https://github.com/Sokori-Inc/plunk/commit/aa4b011678418e28987ec360db1c196c89a1f759))
* integrate DOMPurify for sanitizing HTML content ([bf12392](https://github.com/Sokori-Inc/plunk/commit/bf12392b88fc92b0760333e1b568e3d6d1b6ed74))
* Integrate NuqsAdapter for improved state management and query handling ([0cf0a26](https://github.com/Sokori-Inc/plunk/commit/0cf0a26a97e608f654ed3046c1a46d414557e3ee))
* introduce DataTableFilter and FacetedFilterMenu for unified filtering experience ([44e4e45](https://github.com/Sokori-Inc/plunk/commit/44e4e454c0ecde66b4881a5831def7bee82d0862))
* make detectCustomHtmlPatterns aware of TipTap's actual capabilities ([9797aed](https://github.com/Sokori-Inc/plunk/commit/9797aed47f520aba51bec4e09c9bc4b7762e02f8))
* make detectCustomHtmlPatterns aware of TipTap's actual capabilities ([ba3813e](https://github.com/Sokori-Inc/plunk/commit/ba3813e2422d9fe4e252a90242393cada65644dc))
* make MAIL FROM subdomain configurable via MAIL_FROM_SUBDOMAIN env ([463301b](https://github.com/Sokori-Inc/plunk/commit/463301b5db27b08b483db3c56a992ac62d6653b8))
* make MAIL FROM subdomain configurable via MAIL_FROM_SUBDOMAIN env var ([e0bf0f6](https://github.com/Sokori-Inc/plunk/commit/e0bf0f628af2a155ca3bbc38ef5c2f4ecc0455e6))
* normalize email addresses for contacts to handle case-variants and whitespace ([05c8041](https://github.com/Sokori-Inc/plunk/commit/05c8041a312aaf1328d09ee5b31fb4dbc9ed6e6b)), closes [#403](https://github.com/Sokori-Inc/plunk/issues/403)
* One post click unsubscribe links for Plunk hosted emails ([64b51df](https://github.com/Sokori-Inc/plunk/commit/64b51df8301182aa44b47855b1eb15a06cd3ffaa))
* refactor DashboardLayout to use DropdownMenu for project and user menus ([9cbd5c0](https://github.com/Sokori-Inc/plunk/commit/9cbd5c050eb43a123f1b9f06090aa829796c3a0a))
* refactor template editing layout for improved usability and clarity ([aaf5ac6](https://github.com/Sokori-Inc/plunk/commit/aaf5ac65307266a4d9deb02986b610757e929b49))
* render template variables in WEBHOOK step url, headers and body ([bfecf04](https://github.com/Sokori-Inc/plunk/commit/bfecf04fa38309804ee19e99b9908caf51c5e039))
* render template variables in WEBHOOK step url, headers and body ([c484da8](https://github.com/Sokori-Inc/plunk/commit/c484da88ab7b4635987868e2e3c6fdded68ade8c))
* **SecurityService:** enhance phishing detection by verifying sender domains and institutional TLDs ([6ab4d77](https://github.com/Sokori-Inc/plunk/commit/6ab4d77ca9bebd01f75d8799dad23fdec7768b52))
* **SecurityService:** enhance phishing detection by verifying sender domains and institutional TLDs ([edfc399](https://github.com/Sokori-Inc/plunk/commit/edfc399061cb7fd079b7f11167a2796df766d8ac))
* Sort projects alphabetically in the dashboard and fix layout ([64bd094](https://github.com/Sokori-Inc/plunk/commit/64bd094b47abbc4feaeb93d97915df57763b3907))
* Static segments ([4b51e38](https://github.com/Sokori-Inc/plunk/commit/4b51e386e39ae38d6ea52eb87858de36fa45ab46))
* table view with sorting, faceted filters, and bulk delete  for templates, workflows, and campaigns ([4ccb3d2](https://github.com/Sokori-Inc/plunk/commit/4ccb3d20b1fcfe21f8781777154d05571f3f19c6))
* tanstack table view with sorting, faceted filter, and bulk delete for templates ([55a0c4f](https://github.com/Sokori-Inc/plunk/commit/55a0c4fe239f415b54784270365ee0a3b2b312e2))
* **tests:** enhance test database setup and cleanup for improved isolation and performance ([32dd7bb](https://github.com/Sokori-Inc/plunk/commit/32dd7bba462a6f4a13d59b8fb03708f971d1eff0))
* Update new project bounce thresholds for stricter email handling ([5e62f51](https://github.com/Sokori-Inc/plunk/commit/5e62f517fc896849c270e795cd31a110b83707cc))
* Use campaigns after cancel ([541aca6](https://github.com/Sokori-Inc/plunk/commit/541aca613071bf85d6446a0c5bda966414c463f6))
* **web:** highlight Liquid logic tags in the visual editor ([556167d](https://github.com/Sokori-Inc/plunk/commit/556167da9085f053fc703abf42be626df0381042))
* **web:** insert logic blocks across lines when starting a fresh line ([bfa3ee9](https://github.com/Sokori-Inc/plunk/commit/bfa3ee94c4783e8398e753d5ad3c2a834b46a932))
* **web:** insert, disconnect and reconnect steps in the workflow editor ([68cd243](https://github.com/Sokori-Inc/plunk/commit/68cd2439bd3151eadc85d35a88b1ad582374208c))
* **web:** offer case, contains, for/else, comment and raw blocks ([54c8f30](https://github.com/Sokori-Inc/plunk/commit/54c8f302fe898a1176c937296d3eff586429aa09))
* **web:** offer ready-made Liquid blocks, and rebuild both suggestion menus ([7c3b2ca](https://github.com/Sokori-Inc/plunk/commit/7c3b2ca8fa267261d1950fc18bf6af5edea225ef))
* **web:** report template syntax errors while editing ([c48401b](https://github.com/Sokori-Inc/plunk/commit/c48401bd79ea3558f3772dbcd58fac27caf59b02))
* **web:** scope email editor 'Preview as' to the campaign's segment ([abef349](https://github.com/Sokori-Inc/plunk/commit/abef34949d8d3106f67211d446e97bb91b2fac5c))
* **web:** scope email editor 'Preview as' to the campaign's segment ([184f019](https://github.com/Sokori-Inc/plunk/commit/184f0197238fac37baa4a2536d7cc5519a472bad))
* **web:** warn about field references that will never resolve ([066470c](https://github.com/Sokori-Inc/plunk/commit/066470c77bcc1a1139d3e5a8ad764b682ad6ae16))


### Bug Fixes

* .dockerignore excludes nested build outputs (apps/*/dist, .next, .turbo, etc.) ([3fea06b](https://github.com/Sokori-Inc/plunk/commit/3fea06ba2d7889fdd95b66e49872b6d7f5b3c335))
* .dockerignore excludes nested build outputs (apps/*/dist, .next, .turbo, etc.) ([1d1d407](https://github.com/Sokori-Inc/plunk/commit/1d1d407a6fa336b587d656952b2a4cee14f8d61f))
* Adapt SNS Webhook validation regex pattern to also support AWS eusc partition ([7b6540a](https://github.com/Sokori-Inc/plunk/commit/7b6540a748a90c10f41b931450ac809e7ae23c01))
* add alt text to email badge image ([3b39d84](https://github.com/Sokori-Inc/plunk/commit/3b39d847cd278317723b4b226434c26c49becebe))
* Add in-memory cache for lower-confidence phishing checks ([208c809](https://github.com/Sokori-Inc/plunk/commit/208c809a90d0721261e643523b338d05e23e2bf9))
* add new configuration options for phishing detection thresholds ([c0e0ad8](https://github.com/Sokori-Inc/plunk/commit/c0e0ad8bc6bfdddea5193191156d18aad440c2b0))
* add project name and sender email parameters to phishing content check ([1637d54](https://github.com/Sokori-Inc/plunk/commit/1637d54e1b132dd6864fb1c50d23a388c1c47bf5))
* add project name and sender email parameters to phishing content check ([15294a4](https://github.com/Sokori-Inc/plunk/commit/15294a40d88289fa8fd876c9e7c201eb1e2ca956))
* Add support for STATIC segment type in CampaignService ([7bd098b](https://github.com/Sokori-Inc/plunk/commit/7bd098bdd01a8af0dd41ec515880289b1795e5af))
* Align preview and actual email for templates and campaigns ([cc7fcdb](https://github.com/Sokori-Inc/plunk/commit/cc7fcdb4ef31e9dfb4f7403aa93479b6df56719d))
* **api:** close SSRF bypass via IPv6 transition addresses in webhooks ([a60ce6b](https://github.com/Sokori-Inc/plunk/commit/a60ce6b87c3b88b23365b6cb2367ca4afcb6f772))
* **api:** close SSRF bypass via IPv6 transition addresses in webhooks ([e71c747](https://github.com/Sokori-Inc/plunk/commit/e71c747a84f0858a2861aef9d3034d5bb5f54d87))
* avoid hidden Unicode warning for Welsh flag ([e3bb563](https://github.com/Sokori-Inc/plunk/commit/e3bb563c0bb615a1453eabcf5369289bcf29b0fc))
* broken links to next-wiki.useplunk.com ([e3ea5fb](https://github.com/Sokori-Inc/plunk/commit/e3ea5fb6dcea95b5028f140b77e54d5938497223))
* Center "Add Step" nodes below parent nodes and update positions on drag ([e4e334c](https://github.com/Sokori-Inc/plunk/commit/e4e334c77a7ba41e5a60b69b9c64fa3bb72f1e74))
* coerce boolean and numeric values in custom CSV columns ([4a145f3](https://github.com/Sokori-Inc/plunk/commit/4a145f3488bee63c2d82a4a477f6dfaaaaede64b))
* Connect branches smoothly to original node ([2c3e897](https://github.com/Sokori-Inc/plunk/commit/2c3e8970cbc4ad2eb39fd505a4292345c6cae1c0))
* Consistency across buttons and labels ([c1bcd35](https://github.com/Sokori-Inc/plunk/commit/c1bcd358cc611594d851414687c04bf7a03759a1))
* Consistency across cards ([517753c](https://github.com/Sokori-Inc/plunk/commit/517753c420204510e06decec01db7749894a9265))
* Content negotiation for xml and txt ([c8190b9](https://github.com/Sokori-Inc/plunk/commit/c8190b953f9f2e28e6cfa98e72d8dcfbba7e251b))
* contentId header injection fixed and separte unit test SESService added to verify MIME boundaries ([08e5c0d](https://github.com/Sokori-Inc/plunk/commit/08e5c0d930f1db92b754a018ea08900f93032c64))
* correct cookie domain for .local TLD hostnames ([59aa784](https://github.com/Sokori-Inc/plunk/commit/59aa7845bad69a1768bb88f83cfcea607c447538))
* Correctly hide email verification banner if features is toggled off ([9d3b600](https://github.com/Sokori-Inc/plunk/commit/9d3b6004b91fece20bdc86736e3fd4647153b67c))
* Correctly set domain status on manual verify ([21af8fe](https://github.com/Sokori-Inc/plunk/commit/21af8fe05e0450e8d826a3a01224511a337ca072))
* **dashboard:** table empty-state recovery, bulk button sizing, workflow status+steps, header casing ([157ff34](https://github.com/Sokori-Inc/plunk/commit/157ff34486a5cd4d716cb7176f6e3e86d7109320))
* Do not unsubscribe existing contacts ([2c4d95e](https://github.com/Sokori-Inc/plunk/commit/2c4d95e604cbed9189f7ee07c24b1f236fce7990))
* enhance campaign finalization process to handle pending emails and ensure accurate status updates ([2529c9b](https://github.com/Sokori-Inc/plunk/commit/2529c9b4282b003a94013259119e98654ae22b46))
* Enhance email activity filtering by adding date range checks ([ad0c17d](https://github.com/Sokori-Inc/plunk/commit/ad0c17da566a26a296229c05d9b4e18cf7d401ad))
* Enhance email bounce notification with latest bounce details ([e639c72](https://github.com/Sokori-Inc/plunk/commit/e639c72e8b940ba1da472d355f930359da7c868b))
* enhance email content parsing and logging for better debugging ([4587e9d](https://github.com/Sokori-Inc/plunk/commit/4587e9d670fa3a27fbc1ca7669c8fc75d804e85e))
* Enhance email processing to support campaign types and improve unsubscribe logic ([9e2400c](https://github.com/Sokori-Inc/plunk/commit/9e2400c6de6f13c498f02c489f956ebf89de36b0))
* Enhance email step configuration validation and recipient handling ([b50b5af](https://github.com/Sokori-Inc/plunk/commit/b50b5af763d8a44b09c7022e1d9135bfca7907f6))
* Enhance email step configuration validation and recipient handling ([a99cde8](https://github.com/Sokori-Inc/plunk/commit/a99cde88392450bf719112cb94cc1b9e7c7c1478))
* enhance project name validation to exclude invisible and decorative characters ([29883ff](https://github.com/Sokori-Inc/plunk/commit/29883ffc7104d4beb13965bfa65ea609367ede69))
* enhance Quick Start card layout for improved responsiveness and usability ([649bbf6](https://github.com/Sokori-Inc/plunk/commit/649bbf6d6b9db5139295a455c69425a5565d4323))
* **events:** reject cross-tenant contact and email IDs on event tracking ([7aad5de](https://github.com/Sokori-Inc/plunk/commit/7aad5deb3d03895a0a0c7877edc91aaebb389f8f))
* **events:** reject cross-tenant contact and email IDs on event tracking ([6ff7ad0](https://github.com/Sokori-Inc/plunk/commit/6ff7ad07b8e6b55e4cc5421fb3d351826aef4f0f))
* **filters:** land templates/workflows/campaigns search inputs at 32px to match filter buttons ([283f402](https://github.com/Sokori-Inc/plunk/commit/283f40239dcc81e78d35b39cb9b31f97b435b8d7))
* handle undefined path in footer component for improved stability ([715961c](https://github.com/Sokori-Inc/plunk/commit/715961c007e450731434e5f343acff0debd6a851))
* Harmonize rings and hover states ([f40cc86](https://github.com/Sokori-Inc/plunk/commit/f40cc86cec661899fb862b56ce3e35bf70b33e54))
* Hint custom event names in combobox when no matches are found ([3214f6c](https://github.com/Sokori-Inc/plunk/commit/3214f6c42d4ca6ab628e905ac69ed82648ccf47c))
* Historical backfill of campaign data and improvements to handling ([2211b25](https://github.com/Sokori-Inc/plunk/commit/2211b25c7b8f2586e84bcdd3dae1e9a5ad5c8dff))
* Ignore failed emails to calculate billing limits ([a9532dd](https://github.com/Sokori-Inc/plunk/commit/a9532dd049a7d7eda6f29cd866afa619e8dd22f0))
* Implement content negotiation for markdown and html in middleware ([37ed1e4](https://github.com/Sokori-Inc/plunk/commit/37ed1e49b78eb9339e7b62fd2fd5b60d451707d6))
* implement mergeContactData method for efficient contact data updates ([a27d564](https://github.com/Sokori-Inc/plunk/commit/a27d564e1af6e5cf72c9ef405650f2475bfd0c86))
* Implement merging for activity updates to preserve component state ([0d4b694](https://github.com/Sokori-Inc/plunk/commit/0d4b694208fd8e516e1f50f7384d1ac5bd6561e0))
* Implement SSRF protection in webhook handling with safeFetch method ([2c5a715](https://github.com/Sokori-Inc/plunk/commit/2c5a71518da358927bd5e41035b85fd278790b47))
* improve iframe height adjustment logic in EmailEditor component ([9e4aa94](https://github.com/Sokori-Inc/plunk/commit/9e4aa9443b53ef38a3af1b269f4a949dd57e758f))
* improve layout and accessibility of workflow header and buttons ([ab3edd7](https://github.com/Sokori-Inc/plunk/commit/ab3edd7dc9030eeb770ffd64087476adf10d2d06))
* improve performance tests to work on CI and fix test config ([a3de94d](https://github.com/Sokori-Inc/plunk/commit/a3de94d78954129ced8b673fb327712caba318c2))
* Incrementation on send for stats ([319cee9](https://github.com/Sokori-Inc/plunk/commit/319cee92ca8ba448be7d41e1c46714d1a48a351e))
* log message for projects passing phishing checks ([8628754](https://github.com/Sokori-Inc/plunk/commit/862875428d21de03643e8e51126cc59abef95ccb))
* make email templates, campaigns and workflow search inputs same height as the rest of the app ([8b3657d](https://github.com/Sokori-Inc/plunk/commit/8b3657d056938b17f0634c0fe8d664ae1e07cd73))
* Move Minio from Docker Hub to Quay ([1df7bfb](https://github.com/Sokori-Inc/plunk/commit/1df7bfb3a5c6bb5bf99301daa5dda1e8a80d2655))
* Move Minio from Docker Hub to Quay ([7215b5f](https://github.com/Sokori-Inc/plunk/commit/7215b5f0a27c631745b8a53e6c511dd7eccbd54d))
* normalize field references and handle undefined values in JSON ([b9d692c](https://github.com/Sokori-Inc/plunk/commit/b9d692cf5b491ab22a40ec69e77ff7bdc62eec63))
* pass DISABLE_SIGNUPS and EMAIL_RATE_LIMIT_PER_SECOND through compose; trim .env.self-host.example ([8a26d60](https://github.com/Sokori-Inc/plunk/commit/8a26d605b4aa5fdea0e02a17159c1cae478a7e47))
* pass missing env variables from .env.self-host.example to plunk service ([f178c59](https://github.com/Sokori-Inc/plunk/commit/f178c59b5bc461f9ba57dc6f0bac9617feaab4a3))
* Prevent double delivery of bounce and complaint events ([6bb4351](https://github.com/Sokori-Inc/plunk/commit/6bb4351c15d8d10366098595fb8d2c667ef6f5b7))
* Prevent switching if nodes are attached to multi-branch ([c32b54f](https://github.com/Sokori-Inc/plunk/commit/c32b54f588db79a501db456e6075a337dee8ed26))
* prevent unnecessary state updates in search input effect ([98f1e80](https://github.com/Sokori-Inc/plunk/commit/98f1e80fca8253c125ba24c4d84c5be86841e1fa))
* reconcile totalRecipients in CampaignService to prevent stuck campaigns ([4322de9](https://github.com/Sokori-Inc/plunk/commit/4322de929a84279370bedcbb4f6b7dcd81145aea)), closes [#348](https://github.com/Sokori-Inc/plunk/issues/348)
* Refactor date filtering logic for pagination in ActivityFeed and ActivityService ([52cb2b6](https://github.com/Sokori-Inc/plunk/commit/52cb2b6c77bc3912b356887bdd48e9c8b9b1728a))
* refine date filtering logic for activity feeds and pagination ([3b86873](https://github.com/Sokori-Inc/plunk/commit/3b868734dafad4453c10667d65b34853aaaf1bba))
* Remove 'Optional' label from MAIL FROM Domain and Inbound Email headings ([f9b1354](https://github.com/Sokori-Inc/plunk/commit/f9b135446040de099484db66139560f43bbf027e))
* Remove lock_timeout from migration ([df7afd8](https://github.com/Sokori-Inc/plunk/commit/df7afd8d04b78b71193239a7a3356eeda5bd698c))
* removed "any" data type from SESService.test.ts ([3a42012](https://github.com/Sokori-Inc/plunk/commit/3a42012ac73592a2d2c167fe98a02f5d7614810f))
* replace font loading method with utility function for improved performance ([ba23a1c](https://github.com/Sokori-Inc/plunk/commit/ba23a1c6fa70ca6fa0343391fa8d642155ad45c2))
* replace Select/datalist with styled Combobox for event name inputs ([3e3117e](https://github.com/Sokori-Inc/plunk/commit/3e3117e4a7fbb5f2b029de0bd2ad837928675878))
* safeguard JSON data handling in contacts migration to ensure proper object types ([55a5e4d](https://github.com/Sokori-Inc/plunk/commit/55a5e4d31b666bcef65c6de118ad7564d624f2cd))
* **ses:** emit List-Unsubscribe inside the header section, not the body ([11c428d](https://github.com/Sokori-Inc/plunk/commit/11c428d4ffe7c8aa87aac4d24148aaa95e01507a))
* **smtp:** preserve Reply-To when relaying to /v1/send ([ce3bcf0](https://github.com/Sokori-Inc/plunk/commit/ce3bcf05afb97ab37be944b9b6037d5c60ef8d31))
* **smtp:** preserve Reply-To when relaying to /v1/send ([73d0d5a](https://github.com/Sokori-Inc/plunk/commit/73d0d5a6726539e65edbcdb5d5956be6a850d839))
* standardize step type labels and update visual styles in workflow components ([bdc9b30](https://github.com/Sokori-Inc/plunk/commit/bdc9b30ef29396870aa42515b8e688485a4673e8))
* stub remaining SES calls in DomainService tests ([19ac14c](https://github.com/Sokori-Inc/plunk/commit/19ac14cca261d590a4616b75a00fd69caf243f96))
* Support any locale on creation ([ec1f4c9](https://github.com/Sokori-Inc/plunk/commit/ec1f4c9374e06e3defed3c728be603c10e4e7baa))
* Sync display name in TemplateSearchPicker when initialName changes ([3649392](https://github.com/Sokori-Inc/plunk/commit/3649392b475271198cd61295091e8acf708efa25))
* Sync display name in TemplateSearchPicker when initialName changes ([cbde3cc](https://github.com/Sokori-Inc/plunk/commit/cbde3cce3fcee382dae04e79a9480e67ad896725))
* **templates:** stop rejecting inline bodies on /v1/send ([474034d](https://github.com/Sokori-Inc/plunk/commit/474034df9b521a600ca25147b616dcccbba48624))
* **test:** consolidate SES MIME boundary tests into EmailService.test.ts ([64ba19e](https://github.com/Sokori-Inc/plunk/commit/64ba19e589ed7432f4f79f0315a7ca745cabed22))
* turn warning into success log ([b7eb254](https://github.com/Sokori-Inc/plunk/commit/b7eb2549d433552f32783b6fb8c192f5afb48ecd))
* update activity item colors and backgrounds for improved visual distinction ([e43f70d](https://github.com/Sokori-Inc/plunk/commit/e43f70d8a135b048d4e9ed013ffa25f1b2f89687))
* Update contact subscription logic for upsert operations ([a928666](https://github.com/Sokori-Inc/plunk/commit/a928666dfcdc65c90602051c79b3c008282674aa))
* Update language validation regex to support locale variants ([7834b9e](https://github.com/Sokori-Inc/plunk/commit/7834b9e7ef615ba029a1a091b0c37c8f40eb543c))
* update middleware matcher to exclude webmanifest files ([cbb3bff](https://github.com/Sokori-Inc/plunk/commit/cbb3bffcf4f789e9c36912c9b0ce0ba9f6a1d4dd))
* update not found handling in GET route to return 404 response ([7615b62](https://github.com/Sokori-Inc/plunk/commit/7615b62945aa1939bf6a5b3638c232509090de60))
* update old references to next.useplunk.com ([44987d2](https://github.com/Sokori-Inc/plunk/commit/44987d2b5e8028c6f8f26c39e9dec386e1ccf6e1))
* update phishing confidence threshold to 95% ([bb78c86](https://github.com/Sokori-Inc/plunk/commit/bb78c86c400b60fb0e84c7872e20ad6f7c43c199))
* update project disabled messages for clarity and consistency ([d7eb85f](https://github.com/Sokori-Inc/plunk/commit/d7eb85ffdd99177c5e27104779281f5a08fe36a7))
* update project icon colors for improved visibility and consistency ([5f741c6](https://github.com/Sokori-Inc/plunk/commit/5f741c66c7f0c9c25c45b26917ff68529d15f958))
* update response format for phishing analysis and improve JSON parsing comment ([91d0d2d](https://github.com/Sokori-Inc/plunk/commit/91d0d2d297cb38fe0dfdfd7f73df355e2f51096a))
* update segment filter logic to retain value and unit, enhance activity name mapping ([d1f357c](https://github.com/Sokori-Inc/plunk/commit/d1f357c300c7798d5c8d521e1219e39e7da821dd))
* update segment filter logic to retain value and unit, enhance activity name mapping ([a126563](https://github.com/Sokori-Inc/plunk/commit/a1265635420e66b7cdef02a7136fdf9c3aec4418))
* update TemplateSearchPicker to maintain selected template name on change ([2ea1802](https://github.com/Sokori-Inc/plunk/commit/2ea1802290a4378d68e3878a44e502ea8541b301))
* use literal Welsh flag emoji ([6acfe33](https://github.com/Sokori-Inc/plunk/commit/6acfe338e6940cffb824b6a531b79bf2637d9cf1))
* use Welsh flag emoji ([20361ed](https://github.com/Sokori-Inc/plunk/commit/20361ed1f579c6858adf9a37b8ccfd40f0f26f3c))
* Verify SNS URL before sending fetch request ([b8f1ad9](https://github.com/Sokori-Inc/plunk/commit/b8f1ad9ab53c78f8ef063fdc125f397c8bfc7652))
* visual editor preview ([4451e92](https://github.com/Sokori-Inc/plunk/commit/4451e921caff45dab126006ba103d91816bed696))
* **web:** don't warn about the workflow event payload ([1fac3a8](https://github.com/Sokori-Inc/plunk/commit/1fac3a883d9b7ec2ca3bc1c9021759333177f08a))
* **workflows:** validate template ownership ([bb4f544](https://github.com/Sokori-Inc/plunk/commit/bb4f5440d4a3374fd8cd2b59d8f7c1e5b49311aa))
* **workflows:** validate template ownership ([9836930](https://github.com/Sokori-Inc/plunk/commit/98369303db8fd3bc83f4552edd186446d783ddbd))


### Performance Improvements

* **templates:** stop re-rendering a template that blew a runtime limit ([e78abb7](https://github.com/Sokori-Inc/plunk/commit/e78abb70ce07a9807dc19a420b4fbf9980aed375))


### Code Refactoring

* **api:** rely on auth middleware for domain endpoint permissions ([6aee5db](https://github.com/Sokori-Inc/plunk/commit/6aee5db588183c468e06fab64ca5c9af5b79568d))
* convert forwardRef components to function components for consistency ([361ec0b](https://github.com/Sokori-Inc/plunk/commit/361ec0b1eb17647696656c6a6d4cddd5b9348b45))
* **database:** increase Prisma connection pool limits for improved test performance ([71e2277](https://github.com/Sokori-Inc/plunk/commit/71e227764319e6fc732aefdebd11f3e844257ef6))
* implement step dialog components for workflow editing ([ed9027b](https://github.com/Sokori-Inc/plunk/commit/ed9027b4ef9c37e91c69ed5a90d5b74c08c7a054))
* Redesign domain settings for clearer and smoother setup ([2e90539](https://github.com/Sokori-Inc/plunk/commit/2e9053949568e25b26613d3fc6fb59104d19d338))
* Remove md documents ([df936f3](https://github.com/Sokori-Inc/plunk/commit/df936f342dce295e0ffd31bdc5e76f7740186527))
* remove unnecessary logging for segment processing ([42ceb6e](https://github.com/Sokori-Inc/plunk/commit/42ceb6edc03ebc6f14c6d399e859914ac09f1ab6))
* remove unused .png files ([2d05c3f](https://github.com/Sokori-Inc/plunk/commit/2d05c3fbc1ded87880a307943bb93106b18cd406))
* **SecurityService:** update absolute count ceilings for new projects to improve spam detection ([4de40f4](https://github.com/Sokori-Inc/plunk/commit/4de40f40fa300c9e9ed2ed35f367ca4cd601f309))
* **web:** rewrite UX copy for clarity and consistency ([15ecf58](https://github.com/Sokori-Inc/plunk/commit/15ecf583c5fa747fbd2e13845f1caf588a879feb))
* **web:** rewrite UX copy for clarity and consistency ([a62001e](https://github.com/Sokori-Inc/plunk/commit/a62001e23c78bf512526d35b495e71f51686ffd7))


### Documentation

* Add changelog page ([641283b](https://github.com/Sokori-Inc/plunk/commit/641283b94ef17a002f92728ce8e53c99da6066c1))
* Add content negotiation to apps/wiki ([545d733](https://github.com/Sokori-Inc/plunk/commit/545d7337948f41f006f9cb0270b4bfff2b08ed2c))
* add env-var sync rule to CLAUDE.md ([a348d37](https://github.com/Sokori-Inc/plunk/commit/a348d37c21ecf1d57845f31210f66a8113fadb8d))
* Add inbound to docs ([6c4cc29](https://github.com/Sokori-Inc/plunk/commit/6c4cc295b88db6da8d9edcf23064a3fc8e9f5c36))
* add new recipe pages for waitlist and sync unsubscribes ([01ec34a](https://github.com/Sokori-Inc/plunk/commit/01ec34a8cbbe0f4a158398c0eb8300d847bc29ab))
* Add receiving emails functionality and update DNS records documentation ([b426986](https://github.com/Sokori-Inc/plunk/commit/b42698616a3f7bb079a092375ac886f2a9d7405d))
* add webhooks documentation for real-time event handling ([5bce1d7](https://github.com/Sokori-Inc/plunk/commit/5bce1d74fffb927bcbb2c7df624fde089101efc8))
* correct PHISHING_CONFIDENCE_THRESHOLD default in CLAUDE.md ([5c16679](https://github.com/Sokori-Inc/plunk/commit/5c166797b57f2e7b714957824ee1acdcb22c05f2))
* **env:** add wiki-documented vars to apps/api/.env.example ([81315ea](https://github.com/Sokori-Inc/plunk/commit/81315eac8eb32a7d2e61617c6a84f349afaf7860))
* **env:** sync .env.self-host.example with missing variables ([1c1c95d](https://github.com/Sokori-Inc/plunk/commit/1c1c95d332fb9ab6c2f926f6d51071cfb245ed86))
* **env:** sync env example files, fix CLAUDE.md drift, add process rule ([6ebbb50](https://github.com/Sokori-Inc/plunk/commit/6ebbb50f6817f1354f26cc7734631d3b6ded32ed))
* expand documentation with new sections on importing contacts, unsubscribe pages, and API key management ([4ddafdc](https://github.com/Sokori-Inc/plunk/commit/4ddafdc0419389818de7e45eb4a0c82c2e9382eb))
* Fix broken links on api overview page ([dc2ce02](https://github.com/Sokori-Inc/plunk/commit/dc2ce02d1a4e4d1641728b720ca856cedba719a7))
* Improve self-hosting env variable documentation ([f0ef346](https://github.com/Sokori-Inc/plunk/commit/f0ef34646e7593f07a780141e14d6d2b735c1101))
* Improve webhook documentation ([f6a32ce](https://github.com/Sokori-Inc/plunk/commit/f6a32ce610559050c1ca9978607bd57ac51e906f))
* Static segments ([e8a247f](https://github.com/Sokori-Inc/plunk/commit/e8a247fe12b79ae8a25a74485179e93081fe2002))
* update contacts documentation to include subscription state and email delivery rules ([b4404f6](https://github.com/Sokori-Inc/plunk/commit/b4404f698ec28a59f32d728c15c59c8b7765d377))
* Update OpenAPI spec to reflect implementation ([ff609f8](https://github.com/Sokori-Inc/plunk/commit/ff609f8de1f6c08720a977116ac9b75f759e7dc9))
* update README to clarify self-hosted alternative and add inbound emails feature ([80ef65e](https://github.com/Sokori-Inc/plunk/commit/80ef65e04b8c362f05ae5b7d5710b398a150cce5))
* **wiki:** document MAIL_FROM_SUBDOMAIN and NGINX_PORT env vars ([971b98a](https://github.com/Sokori-Inc/plunk/commit/971b98a4cc6145571204f5a4ad794aa3d09ea71c))
